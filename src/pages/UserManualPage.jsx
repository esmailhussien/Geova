...
const modules = [
  ...
  },
  {
    ...
    desc: '10 field types, guarded spatial auto-fill, capture diagnostics, Lexicon picklists, and conditional rules.',
    icon: 'assignment',
  ...
  },
  {
    ...
    desc: 'Whole-layer spatial queries, zero-credit field intelligence, evidence grades, guarded form actions, and exports.',
    icon: 'psychology',
